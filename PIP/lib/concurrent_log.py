...
class ConcurrentLogFileLock(PortaLock):
    ...
    def __init__(self, filename, *args, **kwargs):
        PortaLock.__init__(self, self.__get_lock_filename(filename), *args, **kwargs)

    def __get_lock_filename(self, log_file_name):
        """
...
class GetLogger:
    ...
    def __init__(self, logs_dir=None, logs_level=logging.INFO, log_name=r'app.log'):
